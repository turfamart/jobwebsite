            ...
            <div class="col-md-4 col-lg-3 sidebar mb-4">
                <div class="card border-0 shadow p-4">
                    ...
                    <div class="mb-4">
                        ...
                        @foreach($jobType as $jobTyp)
                        <div class="form-check mb-2"> 
                            <input class="form-check-input" name="job_type" type="checkbox" value="{{ $jobTyp->id }}" id="jobtype-{{ $jobTyp->id }}">    
                            <label class="form-check-label" for="jobtype-{{ $jobTyp->id }}"">{{ $jobTyp->name }}</label>
                        </div>
                        @endforeach
